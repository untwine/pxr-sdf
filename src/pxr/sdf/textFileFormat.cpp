...
#include "pxr/sdf/textFileFormat.h"
#include "pxr/sdf/usdaFileFormat.h"
#include "pxr/sdf/fileIO.h"
#include "pxr/sdf/fileIO_Common.h"
...
extern bool Sdf_ParseLayer(
    ...
    const std::shared_ptr<AR_NS::ArAsset>& asset,
    const string& token,
    const string& version,
    bool metadataOnly,
    SDF_NS::SdfUsdaDataRefPtr data,
    SDF_NS::SdfLayerHints *hints);
